...
def parse_args():
    ...
    parser.add_argument(
        "input_file",
        type=Path,
        help="QC-cleaned NG00175 GWAS file"
    )
...
def main():
    ...
    # Prevent duplicate output if script is rerun
    ...
    for chunk in pd.read_csv(
        ...
        # Suggestive only: exclude genome-wide significant variants
        suggestive = chunk[
            (chunk["P"] >= GENOME_WIDE_THRESHOLD)
